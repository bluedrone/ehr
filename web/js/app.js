...
var app_patientChartCity;
var app_patientChartUSState;
var app_patientChartPostalCode;
var app_patientChartAddress;
...
function viewClinicianMessage() {
  ...
  getPatientEncounters();
    ...
    $.post("app/getPatientChart", {data:jsonData}, function(data) {
      ...
      app_patientChartAddress = parsedData.streetAddress1;
      app_patientChartCity = parsedData.city;
      app_patientChartUSState = parsedData.usState;
      app_patientChartPostalCode = parsedData.postalCode;
      ...
      $('.patient-chart-city').html(app_patientChartCity);
