...
public class Encounter extends BaseEntity implements Serializable {
  ...
  @ManyToOne(optional = true)
  public OBGYNEncounterData getObgyn() {
    return obgyn;
  }

  public void setObgyn(OBGYNEncounterData obgyn) {
    this.obgyn = obgyn;
  }
  ...
  public void setConsultLocation(String consultLocation) {
  ...
  @ManyToOne(optional = true)
  public SuppQuestions getSupp() {
    return supp;
  }

  public void setSupp(SuppQuestions supp) {
    this.supp = supp;
  }

  @Column(name = "basic_info_saved")
  public Boolean getBasicInfoSaved() {
  ...
  public Boolean getVitalsSaved() {
    return vitalsSaved;
  }

  public void setVitalsSaved(Boolean vitalsSaved) {
    this.vitalsSaved = vitalsSaved;
  }

  @Column(name = "family_saved")
  public Boolean getFamilySaved() {
    return familySaved;
  }

  public void setFamilySaved(Boolean familySaved) {
    this.familySaved = familySaved;
  }

  @Column(name = "cc_saved")
  public Boolean getCcSaved() {
    return ccSaved;
  }

  public void setCcSaved(Boolean ccSaved) {
    this.ccSaved = ccSaved;
  }

  @Column(name = "obgyn_saved")
  public Boolean getObgynSaved() {
    return obgynSaved;
  }

  public void setObgynSaved(Boolean obgynSaved) {
    this.obgynSaved = obgynSaved;
  }

  @Column(name = "pfsh_saved")
  public Boolean getPfshSaved() {
    return pfshSaved;
  }

  public void setPfshSaved(Boolean pfshSaved) {
    this.pfshSaved = pfshSaved;
  }

  @Column(name = "supp_saved")
  public Boolean getSuppSaved() {
    return suppSaved;
  }

  public void setSuppSaved(Boolean suppSaved) {
    this.suppSaved = suppSaved;
  }

  @Column(name = "hist_saved")
  public Boolean getHistSaved() {
    return histSaved;
  }

  public void setHistSaved(Boolean histSaved) {
    this.histSaved = histSaved;
  }

  @Column(name = "exam_saved")
  public Boolean getExamSaved() {
    return examSaved;
  }

  public void setExamSaved(Boolean examSaved) {
    this.examSaved = examSaved;
  }

  @Column(name = "follow_up_saved")
  public Boolean getFollowUpSaved() {
    return followUpSaved;
  }

  public void setFollowUpSaved(Boolean followUpSaved) {
    this.followUpSaved = followUpSaved;
  }
  ...
  public int hashCode() {
    ...
    result = prime * result
        + ((familySaved == null) ? 0 : familySaved.hashCode());
    result = prime * result
  ...
  public boolean equals(Object obj) {
    ...
    if (examSaved == null) {
      ...
      {return false;}
    if (familySaved == null) {
      if (other.familySaved != null)
        {return false;}
    } else if (!familySaved.equals(other.familySaved))
      {return false;}
    if (followUp == null) {
  ...
  public String toString() {
    return "Encounter [date=" + date + ", patient=" + patient
        ...
        + ", familySaved=" + familySaved + ", ccSaved=" + ccSaved
