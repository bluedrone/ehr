...
public class Appointment extends BaseEntity implements Serializable {
  ...
  public int hashCode() {
    ...
    result = prime * result
        + ((appointmentType == null) ? 0 : appointmentType.hashCode());
  ...
  public boolean equals(Object obj) {
    ...
    if (appointmentType == null) {
      if (other.appointmentType != null) { return false; }
    } 
    else if (!appointmentType.equals(other.appointmentType)) { return false; }
    if (clinician == null) {
    ...
    if (endTime == null) { if (other.endTime != null) { return false; } } 
  ...
  public String toString() {
    return "Appointment [startTime=" + startTime + ", endTime=" + endTime
        + ", dayOfWeek=" + dayOfWeek + ", override=" + override
        + ", patient=" + patient + ", clinician=" + clinician
        + ", department=" + department + ", appointmentType="
        + appointmentType + "]";
  }
