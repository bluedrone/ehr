...
public class ChiefComplaint extends BaseEntity implements Serializable {
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((daysSince == null) ? 0 : daysSince.hashCode());
		result = prime * result + ((denies == null) ? 0 : denies.hashCode());
		result = prime * result
				+ ((deniesOther == null) ? 0 : deniesOther.hashCode());
		result = prime * result
				+ ((description == null) ? 0 : description.hashCode());
		result = prime * result
				+ ((encounterId == null) ? 0 : encounterId.hashCode());
		result = prime * result
				+ ((hoursSince == null) ? 0 : hoursSince.hashCode());
		result = prime * result
				+ ((howLongOther == null) ? 0 : howLongOther.hashCode());
		result = prime * result
				+ ((monthsSince == null) ? 0 : monthsSince.hashCode());
		result = prime * result
				+ ((occursWhen == null) ? 0 : occursWhen.hashCode());
		result = prime * result
				+ ((painDuration == null) ? 0 : painDuration.hashCode());
		result = prime * result
				+ ((painScale == null) ? 0 : painScale.hashCode());
		result = prime * result
				+ ((painType == null) ? 0 : painType.hashCode());
		result = prime * result
				+ ((painXDay == null) ? 0 : painXDay.hashCode());
		result = prime * result
				+ ((painXHour == null) ? 0 : painXHour.hashCode());
		result = prime * result
				+ ((painXMonth == null) ? 0 : painXMonth.hashCode());
		result = prime * result
				+ ((painXWeek == null) ? 0 : painXWeek.hashCode());
		result = prime * result
				+ ((patientId == null) ? 0 : patientId.hashCode());
		result = prime
				* result
				+ ((specificLocation == null) ? 0 : specificLocation.hashCode());
		result = prime * result
				+ ((weeksSince == null) ? 0 : weeksSince.hashCode());
		result = prime * result
				+ ((yearsSince == null) ? 0 : yearsSince.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (denies == null) {
			...
			return false;
		if (deniesOther == null) {
			if (other.deniesOther != null)
				return false;
		} else if (!deniesOther.equals(other.deniesOther))
			return false;
		if (description == null) {
		...
		if (encounterId == null) {
			...
			return false;
		if (hoursSince == null) {
			if (other.hoursSince != null)
				return false;
		} else if (!hoursSince.equals(other.hoursSince))
			return false;
		if (howLongOther == null) {
			if (other.howLongOther != null)
				return false;
		} else if (!howLongOther.equals(other.howLongOther))
			return false;
		if (monthsSince == null) {
			if (other.monthsSince != null)
				return false;
		} else if (!monthsSince.equals(other.monthsSince))
			return false;
		if (occursWhen == null) {
			if (other.occursWhen != null)
				return false;
		} else if (!occursWhen.equals(other.occursWhen))
			return false;
		if (painDuration == null) {
			if (other.painDuration != null)
				return false;
		} else if (!painDuration.equals(other.painDuration))
			return false;
		if (painScale == null) {
			if (other.painScale != null)
				return false;
